...
const Login = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-74px)] flex justify-center items-center bg-sformColor">
      {step === 1 ? (
        <React.Fragment>
          <form
            onSubmit={handleSubmit(onLoginHandler)}
            className="sm:w-[450px] w-[360px]  shadow-custom py-8 sm:px-8 px-4 bg-testimonialCard"
          >
            <div>
