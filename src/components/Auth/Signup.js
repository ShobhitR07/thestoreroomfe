...
const Signup = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-74px)] flex justify-center items-center bg-supColor ">
      <form
        onSubmit={handleSubmit(onSubmitHandler)}
        className="sm:w-[450px] w-[360px]  shadow-custom py-6 sm:px-8 px-4 bg-testimonialCard"
      >
        <div >
          ...
          <p className="text-white text-center">
            Enter your credentials to create a new Room
          </p>
          ...
          <Divider className="font-semibold text-white">STORE ROOM</Divider>
        </div>
