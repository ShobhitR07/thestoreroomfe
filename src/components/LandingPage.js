...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-74px)] flex justify-center bg-bgcolor ">
      <div className="lg:w-[80%] w-full py-16  space-y-4  ">
        ...
        >
          ...
          {/* Effortlessly Copy, Securely Store, and Seamlessly Transfer Your Data! */}
          Create a room. Store your data. Log in from other device. Access that data. 
        </motion.h1>
        <h3 className="text-logoText md:text-2xl text-xl font-semibold text-slate-800 text-center">
          {/* The #1 secure note-taking app. */}
          The #1 app for effortless data transfering between different devices.
          <br/>Have privacy concerns? <br/>Don't worry! each data room has a life of only 24 hours after which your data and your room will be completely erased.
          
        </h3>
        <p className="text-slate-700 text-center sm:w-[80%] w-[90%] mx-auto">
          Manage your data effortlessly and securely. Just type, save, and
