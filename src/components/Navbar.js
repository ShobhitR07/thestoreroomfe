...
const Navbar = () => {
  ...
  return (
    ...
    <header className="h-headerHeight   text-textColor bg-headerColor shadow-sm   items-center sticky top-0    z-50 flex
    ...
    ">
      <nav className="sm:px-10 px-4 flex w-full h-full items-center justify-between  ">
        <Link to="/">
          {" "}
          <h3 className=" font-dancingScript text-logoText">Store Room</h3>
        </Link>
        <ul
