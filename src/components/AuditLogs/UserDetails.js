...
const UserDetails = () => {
  ...
  return (
    <div className="sm:px-12 px-4 py-10  bg-adminArea ">
      {loading ? (
        <>
          {" "}
        ...
        <>
          <div className="lg:w-[70%] sm:w-[90%] w-full  mx-auto shadow-lg shadow-gray-300 p-8 rounded-md bg-black">
            <div>
              ...
              >
                ...
                {!isEditingPassword ? (
                  <Buttons
                    ...
                    className="bg-customRed mb-0 w-fit px-4 py-2 rounded-md "
                  >
          ...
          <div className="lg:w-[70%] sm:w-[90%] w-full  mx-auto shadow-lg shadow-gray-300 bg-red-950 p-8 rounded-md">
            <h1 className="text-white text-2xl font-bold  pb-4">
              Admin Actions
              <hr />
            </h1>
            ...
            <div className="flex flex-col gap-4 py-4">
              <div className="flex items-center gap-2">
                <label className="text-white text-sm font-semibold uppercase">
                  {" "}
                  Lock Account
                </label>
                <input
